...
public class EditMhsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://praktikum-firebase-3fda0-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("mhs").child(nim);
